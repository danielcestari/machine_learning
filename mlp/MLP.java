...
public class MLP
{
  ...
  public MLP (double eta, String trainFile, String testFile,
  ...
  public void printInfo() {
	...
	System.out.println("Information about output weights");
	for (int i = 0; i < this.outputLayer.size(); i++) {
		Neuron n = this.outputLayer.get(i);
		for (int j = 0; j < n.getWeights().length; j++) {
			System.out.print(n.getWeights()[j]+"\t");
		}
		System.out.println();
  ...
  public static void main (String args[]) throws Exception
  {
	...
	System.out.
	  println
	  ("java MLP eta trainFile testFile inputLength hiddenLength outputLength threshold");
	System.exit (0);
      }
    ...
    MLP mlp = new MLP (eta, trainFile, testFile,
